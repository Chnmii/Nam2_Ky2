package sodoku.oopsimple_iodb.model;
...
public class Node {
	...
	private int calculateZone(){
		int r = this.row / Constants.InitConfiguration.ZONE_SIZE;
		int c = this.col / Constants.InitConfiguration.ZONE_SIZE;
		int zone = r * Constants.InitConfiguration.ZONE_SIZE + c;
		return zone;
	}
}
